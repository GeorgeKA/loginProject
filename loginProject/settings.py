...
TEMPLATE_DIRS = (os.path.join(BASE_DIR, './loginProject/templates'),)
LOGIN_URL = 'django.contrib.auth.views.login'
LOGIN_REDIRECT_URL = 'django.contrib.auth.views.login'
#LOGIN_REDIRECT_URL = '/'
LOGOUT_URL = 'django.contrib.auth.views.logout'
LOGOUT_REDIRECT_URL = 'django.contrib.auth.views.login'

# Quick-start development settings - unsuitable for production
# See https://docs.djangoproject.com/en/1.7/howto/deployment/checklist/

# SECURITY WARNING: keep the secret key used in production secret!
SECRET_KEY = '__6prq7!w-9gv%*#r98oc20zukd5oc-3q9l9v_c!eslom30ntr'
